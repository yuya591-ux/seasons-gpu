...
await p.screenshot({ path: 'scripts/_shots/rainnight-window.png' })
...
await p.screenshot({ path: 'scripts/_shots/rainnight-air.png' })
...
await p.screenshot({ path: 'scripts/_shots/rainnight-walk.png' })
