...
await p.evaluate(() => window.__applyScene('kitaterao-window-3d-snow-night'))
await p.waitForTimeout(3000)
const pal = await p.evaluate(() => window.__town3dPalProbe())
console.log('palette:', JSON.stringify(pal))
await p.screenshot({ path: 'scripts/_shots/snownight-window.png' })
...
await p.screenshot({ path: 'scripts/_shots/snownight-walk.png' })
