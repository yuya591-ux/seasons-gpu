...
for (const [id,f] of [['kitaterao-rooftop','qc-rooftop'],['kitaterao-rooftop-night','qc-rooftop-night'],['spring-morning-corner-room','qc-spring-cr'],['summer-morning-corner-room','qc-summer-cr']]) {
