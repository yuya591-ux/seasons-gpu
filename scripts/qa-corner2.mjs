...
await page.screenshot({ path: 'scripts/_shots/qa-corner2-front.png' })
await page.evaluate(() => window.__town3dSetView && window.__town3dSetView(0.82, 0))
await page.waitForTimeout(900)
await page.screenshot({ path: 'scripts/_shots/qa-corner2-right.png' })
