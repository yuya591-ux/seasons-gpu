...
// 海の上(x=94)から西を向いて渚を見る
await p.evaluate(()=>window.__town3dFlyPose(94, 5, 40, -1.57, -0.22)).catch(()=>{}); await p.waitForTimeout(1600)
await p.screenshot({ path:'foam2-a.png' }); console.log('a')
// もっと近く・低く
await p.evaluate(()=>window.__town3dFlyPose(88, 2.5, 55, -1.4, -0.12)).catch(()=>{}); await p.waitForTimeout(1600)
await p.screenshot({ path:'foam2-b.png' }); console.log('b')
