...
await page.evaluate(() => window.__applyScene && window.__applyScene('summer-morning-corner-room'))
await page.waitForTimeout(1800)
await page.screenshot({ path: 'scripts/_shots/pt_morn_front.png' })
...
await page.screenshot({ path: 'scripts/_shots/pt_morn_down.png' })
await browser.close()
console.log('done')
