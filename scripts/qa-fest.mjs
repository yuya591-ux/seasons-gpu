...
await p.goto(`http://localhost:${port}/seasons-gpu/?dev=1&fest=1`, { waitUntil: 'networkidle' })
...
const shots = [
  ['fest-school', [44, 16, 2, 54, 2.5, -12, 60]],   // 校庭の盆踊りを斜め上から（会場は54,-12へ前進）
  ['fest-plaza', [-11, 12, 18, 0, 2.0, 6, 54]],      // 窓前広場の盆踊りを斜め上から（ユーザーが見た会場）
