...
await p.evaluate(()=>window.__town3dFlyPose(7.2, 2.6, -9, Math.PI, -0.16)).catch(()=>{}); await p.waitForTimeout(1500)
await p.screenshot({ path:'engawa-a.png' }); console.log('a')
await p.evaluate(()=>window.__town3dFlyPose(-6.8, 2.4, -27, Math.PI, -0.12)).catch(()=>{}); await p.waitForTimeout(1500)
await p.screenshot({ path:'engawa-b.png' }); console.log('b')
